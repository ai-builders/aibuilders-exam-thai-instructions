...
#### ฟังก์ชันรีเทิร์นค่า
- สตริงที่ประกอบด้วยเลขของ quadrant (1-9) ที่มีเลขที่ทำผิดกฎ (มีเลข 1-9 ซ้ำใน quadrant, แถว หรือคอลัมน์)
- หากมี quadrant ทีผิดกฎมากกว่า 1 อันให้คั่นด้วยเครื่องหมาย `,` เช่น `1,2,3`
